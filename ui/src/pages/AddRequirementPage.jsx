...
import {
  resetState,
  submitRequirement,
} from "../features/requirements/requirementsSlice";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      if (submitRequirement.fulfilled.match(resultAction)) {
        toast.success(
          resultAction.payload?.message || "Requirement submitted!"
        );
        resetForm();
      } else {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-gray-800 font-bold text 3xl my-2">
          Add Requirement
        </h1>
        <p className="text-gray-600">
          Submit your product requirements to farmers
        </p>
      </div>
